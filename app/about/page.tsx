                ...
                {[
                  {
                    ...
                    delay: 0,
                    shortBio:
                      "Parvinjeet Kaur is the Founder and Chief Executive Officer of CAFIA. With an MBA from MIT Sloan School of Management and ACCA qualification, she is a leading architect of inclusive finance ecosystems in Africa.",
                    fullBio: (
                      <>
                        <p>
                          Parvinjeet Kaur is the Founder and Chief Executive Officer of CAFIA, where she leads strategy,
                  ...
                  },
                  {
                    ...
                    delay: 0.15,
                    shortBio:
                      "Dr. Muhammad-Abbas Conteh is a physician and health systems specialist who leads CAFIA's health inclusion initiatives, connecting healthcare access with financial resilience.",
                    fullBio: (
                      <>
                        <p>
                          Dr. Muhammad-Abbas Conteh is a physician and health systems specialist who leads CAFIA's
                          health inclusion initiatives. Board-certified by the American Board of Internal Medicine
                          (ABIM), he brings clinical expertise and strategic insight into health policy design and
                          implementation.
                        </p>
                        <p>
                          At CAFIA, Dr. Conteh focuses on integrating health access with economic resilience, designing
                          programs that reduce health-related financial shocks for households and enterprises. His work
                          includes health insurance advocacy, medical credit solutions, and partnerships with public and
                          private health systems.
                        </p>
                        <p>
                          He is committed to ensuring that health challenges do not derail economic progress for African
