      ...
      <div className="container relative z-10 max-w-screen-xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto leading-relaxed px-4">
            Addressing every aspect of financial inclusion across Africa
          </p>
        </motion.div>
            ...
            >
              {pillars.map((pillar, index) => (
                ...
                >
                  ...
                  <div className="bg-white rounded-2xl shadow-lg p-6 w-full text-center hover:shadow-xl hover:scale-105 transition-all duration-300 group">
