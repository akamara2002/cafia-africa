...
const footerLinks = {
  ...
  Programs: [
    {
      name: "Research, Policy & Academy",
      href: "/strategic-pillars#research-policy-academy",
    },
    {
      name: "Technology & Innovation",
      href: "/strategic-pillars#technology-innovation",
    },
    {
      name: "Sustainable & Inclusive Finance",
      href: "/strategic-pillars#sustainable-inclusive-finance",
    },
  ],
  Connect: [
...
export default function Footer() {
  ...
  useEffect(() => {
    // Only generate positions on client side to avoid hydration mismatch
    setDotPositions(
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © 2026 CAFIA. All rights reserved.
            </p>
